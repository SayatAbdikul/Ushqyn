...
create_project -name phase4_hs_sdram_bist -dir [pwd] -pn GW2AR-LV18QN88C8/I7 -device_version C
set_device -device_version C GW2AR-LV18QN88C8/I7
add_file [file join $root hardware/phase4_sdram/pll.v]
add_file $ip
add_file [file join $root hardware/phase4_sdram/hs_byte_adapter.sv]
add_file [file join $root hardware/phase4_sdram/bist_hs.sv]
...
set_option -top_module phase4_hs_sdram_bist
set_option -verilog_std sysv2017
set_option -output_base_name phase4_hs_sdram_bist
run all
exit
