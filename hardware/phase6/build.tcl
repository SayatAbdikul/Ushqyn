# Boardless build only. No programmer or device operations.
...
if {![info exists ::env(PHASE6_ENGINE)]} {error "Use tools/phase6/run_gowin.py"}
create_project -name phase6_tiled_host -dir [pwd] -pn GW2AR-LV18QN88C8/I7 -device_version C
...
set_option -top_module phase5_tiled_host
set_option -verilog_std sysv2017
set_option -output_base_name phase6_tiled_host
run all
exit
