...
**Implementation record:** see [phase 0–1 status](research/PHASE_0_1_STATUS.md), the [phase 2 physical gate](research/PHASE_2_STATUS.md), the [Phase 3 status](research/PHASE_3_STATUS.md) and the [G3 board closure](research/PHASE_3_CLOSURE.md). G2 and G3 have passed real-board validation. The on-chip SmallCNN is exact; complete KWS/VWW execution and SDRAM remain later gates.
